...
| Баланс классов | Сбалансированный (~50% / ~50%) |
...
Датасет **сбалансирован** - классы распределены примерно поровну (~50% / ~40%), что упрощает обучение и не требует специальных техник работы с дисбалансом.
...
2. **Лучшая модель - Random Forest**: наивысший Accuracy (0.95) на тестовой выборке, наилучший баланс между качеством и обобщением.
